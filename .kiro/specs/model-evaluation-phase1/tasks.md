...
- [ ] 3. Implement evaluation launcher handler (TypeScript Lambda)
  - [ ] 3.1 Create layered architecture: handler → use case → service layer
    - Write handler function to parse evaluation request
    - Implement EvaluationLaunchUseCase with validation and job creation
    - Implement EvaluationService with DynamoDB and Fargate operations
  ...
  - [ ] 3.7 Implement weight configuration validation and normalization
  ...
  - [ ] 3.13 Implement Fargate container launch
  ...
  - [ ] 3.16 Implement error handling and response formatting
    - Return consistent error response format
...
- [ ] 4. Implement status and results handlers (TypeScript Lambda)
  - [ ] 4.1 Create status handler with layered architecture
    ...
    - Implement StatusQueryUseCase to retrieve job status
    - Implement StatusService with DynamoDB query operations
  ...
  - [ ] 4.5 Create results handler with layered architecture
    - Write handler function to parse evaluation_id from path
    - Implement ResultsQueryUseCase to retrieve evaluation results
    - Implement ResultsService with DynamoDB query operations
...
- [ ] 6. Implement Python evaluation engine core
  ...
  - [ ] 6.2 Implement dataset loader
    ...
    - Return dataset structure with prompts, context, reference_outputs
    - _Requirements: 3.3_
...
- [ ] 7. Implement Bedrock client for model invocations
  - [ ] 7.1 Create Bedrock client with invocation tracking
    ...
    - Implement invoke_model method that accepts model_id, prompt, optional context
  ...
  - [ ] 7.4 Implement error handling for model invocations
    - Catch and log Bedrock API errors with model_id, prompt_id, error details
...
- [ ] 8. Implement metric calculator for accuracy metrics
  - [ ] 8.1 Set up fmeval and DeepEval dependencies
  ...
  - [ ] 8.7 Implement G-eval metrics with Claude Opus judge
  ...
  - [ ]* 8.8 Write unit tests for G-eval metrics
  ...
  - [ ] 8.9 Implement conditional accuracy calculation
    - Check if dataset has reference_output fields
    - Skip all accuracy metrics if no reference outputs
    - Return None/null for accuracy metrics when skipped
    - _Requirements: 4.10_

  - [ ]* 8.10 Write property test for accuracy metrics conditional computation
    - **Property 18: Accuracy Metrics Conditional Computation**
    - **Validates: Requirements 4.10**

  - [ ]* 8.11 Write property test for accuracy metrics completeness
    - **Property 16: Accuracy Metrics Completeness**
    - **Validates: Requirements 4.1, 4.2, 4.3, 4.4, 4.5, 4.6, 4.7**

  - [ ] 8.12 Implement error handling for metric calculation
  ...
  - [ ]* 8.13 Write property test for partial results on failure
    - **Property 46: Partial Results on Failure**
    - **Validates: Requirements 11.5**


- [ ] 9. Implement metric calculator for latency and cost metrics
  - [ ] 9.1 Implement tokens per second calculation
  ...
  - [ ]* 9.10 Write property test for cost calculation formula
    - **Property 21: Cost Calculation Formula**
    - **Validates: Requirements 5.7**

  - [ ]* 9.11 Write property test for cost aggregation
    - **Property 22: Cost Aggregation**
    - **Validates: Requirements 5.8**

  - [ ]* 9.12 Write unit tests for cost calculation
  ...
  - [ ] 9.13 Implement complete metrics aggregation
  ...
  - [ ]* 9.14 Write property test for metrics computation completeness
    - **Property 14: Metrics Computation Completeness**
    - **Validates: Requirements 3.7**

  - [ ]* 9.15 Write integration tests for complete metric calculation
...
- [ ] 10. Implement model recommender
  - [ ] 10.1 Implement metric normalization
  ...
  - [ ]* 10.6 Write property test for weighted score computation
    - **Property 31: Weighted Score Computation**
    - **Validates: Requirements 8.1**

  - [ ]* 10.7 Write property test for custom weights application
    - **Property 32: Custom Weights Application**
    - **Validates: Requirements 8.2**

  - [ ]* 10.8 Write property test for zero weight exclusion
    - **Property 52: Zero Weight Exclusion**
    - **Validates: Requirements 12.4**

  - [ ]* 10.9 Write unit tests for weighted score calculation
    - Test with equal weights
    - Test with custom weights
    - Test with zero weight for one dimension
    - _Requirements: 8.1, 8.2, 12.4_

  - [ ] 10.10 Implement recommendation selection
  ...
  - [ ]* 10.11 Write property test for recommendation selection
    - **Property 35: Recommendation Selection**
    - **Validates: Requirements 8.6**

  - [ ]* 10.12 Write unit tests for recommendation
...
- [ ] 11. Implement results storage and engine orchestration
  - [ ] 11.1 Implement results writer for DynamoDB
  ...
  - [ ]* 11.2 Write property test for results storage round-trip
    - **Property 15: Results Storage Round-Trip**
    - **Validates: Requirements 3.8**

  - [ ]* 11.3 Write integration tests for results storage
    - Test storing complete results
    - Test storing partial results with failures
    - Test DynamoDB write failures
    - _Requirements: 3.8_

  - [ ] 11.4 Wire evaluation engine components together
  ...
  - [ ]* 11.5 Write integration tests for complete evaluation flow
  ...
  - [ ] 11.6 Implement timeout handling
  ...
  - [ ]* 11.7 Write unit tests for timeout handling
    - Test timeout detection
    - Test partial results storage on timeout
    - _Requirements: 3.9_

- [ ] 12. Checkpoint - Evaluation engine complete
...
- [ ] 13. Implement React frontend components
  ...
  - [ ]* 13.6 Write unit tests for weight configuration
    - Test weight input and normalization display
    - Test zero weight handling
    - _Requirements: 12.1, 12.2, 12.3, 12.4_

  - [ ] 13.7 Create evaluation configuration wizard
  ...
  - [ ]* 13.8 Write integration tests for wizard flow
    - Test complete wizard flow from upload to submission
    - Test validation at each step
    - _Requirements: 1.1, 2.1, 12.1_

  - [ ] 13.9 Create progress tracking component
  ...
  - [ ]* 13.10 Write unit tests for progress component
    - Test polling logic
  ...
  - [ ] 13.11 Create radar chart visualization component
  ...
  - [ ]* 13.12 Write unit tests for radar chart
    - Test chart rendering with sample data
    - Test recommended model highlighting
    - _Requirements: 7.3, 8.7_

  - [ ] 13.13 Create metrics table component
  ...
  - [ ]* 13.14 Write property test for accuracy metrics display
    - **Property 28: Accuracy Metrics Display**
    - **Validates: Requirements 7.5**

  - [ ]* 13.15 Write property test for performance metrics display
    - **Property 29: Performance Metrics Display**
    - **Validates: Requirements 7.6**

  - [ ]* 13.16 Write unit tests for metrics table
    - Test table rendering with complete metrics
    - Test table rendering without accuracy metrics
    - Test recommended model highlighting
    - _Requirements: 7.4, 7.5, 7.6_

  - [ ] 13.17 Create recommendation display component
  ...
  - [ ]* 13.18 Write unit tests for recommendation display
    - Test recommendation rendering
    - Test weights display
    - _Requirements: 8.6, 8.7, 12.5_

  - [ ] 13.19 Create results page combining all visualization components
  ...
  - [ ]* 13.20 Write integration tests for results page
    - Test complete results display
    - Test error handling for non-existent jobs
    - Test loading states
    - _Requirements: 7.1, 7.2, 7.7_

  - [ ] 13.21 Implement error handling and user feedback
  ...
  - [ ]* 13.22 Write unit tests for error handling
    - Test validation error display
    - Test API error display
    - _Requirements: 11.1, 11.6_


- [ ] 14. Implement API client and state management
  - [ ] 14.1 Create TypeScript API client for frontend
  ...
  - [ ] 14.3 Implement state management for evaluation workflow
  ...
  - [ ]* 14.4 Write unit tests for state management
    - Test state transitions
    - Test data persistence
    - _Requirements: 1.4, 3.1, 6.1, 7.1_

- [ ] 15. Implement security and input validation
  - [ ] 15.1 Add input validation to all API handlers
...
- [ ] 17. Integration and end-to-end testing
  ...
  - [ ] 17.2 Write end-to-end tests for critical user flows
    - Test complete evaluation workflow from upload to results viewing
    - Test with CSV dataset containing reference outputs
    - Test with JSONL dataset without reference outputs
    - Test with custom model endpoint
    - Test with custom weights
    - Use Playwright or Cypress for browser automation
    - _Requirements: 1.1, 2.1, 3.1, 6.1, 7.1, 12.1_

  - [ ] 17.3 Test error handling across system boundaries
  ...
  - [ ] 17.4 Test timeout and resilience scenarios
  ...
  - [ ] 17.5 Verify property-based test coverage
    - Ensure all 52 correctness properties have corresponding property tests
    - Run all property tests with 100+ iterations
    - Document any properties that cannot be tested with property-based testing
    - _Requirements: All requirements_

  - [ ] 17.6 Verify test coverage meets 80% minimum
...
- [ ] 18. Deployment and infrastructure finalization
  - [ ] 18.1 Complete SAM template with all resources
  ...
  - [ ] 18.3 Configure monitoring and logging
  ...
  - [ ] 18.4 Create infrastructure documentation
...
- [ ] 19. Final checkpoint - Complete system validation
  ...
  - Verify all 52 correctness properties are validated
